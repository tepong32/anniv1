...
define t = Character("Teppy", color="#f88787", image="eileen")
# define e_nvl = Character("Eileen", color="#f88787", kind=nvl, image="eileen")         # IDK what this is for yet
...
label start:
    ...
    show shirt smile01 at center:

        ## Sprite generated by Mannequin are fullbody, so we do need to
        ## move avatar down slightly so she's not floating about.
        # yoffset 250
        zoom 0.6    # character's too close at 1.0 zoom. Adjust accordingly
    ...
    show shirt erm01 with dissolve

    t "Once you add a story, pictures, and music, you can release it to the world!"

    show shirt happy01 with dissolve

    t "Haha, sorry. Had to get that out of the way first."

    t "Thanks for downloading this All-In-One GUI Template! After you play through this script, be sure to open up the files and adjust the {color=#32CD32}options.rpy{/color}, {color=#32CD32}gui.rpy{/color}, and {color=#32CD32}screens.rpy{/color} to fit your own project's needs!"

    t "You can even make a copy of the entire {color=#32CD32}game{/color} folder and start your project from there."
    
    t "So now, let's demonstrate some of the custom Accessibility Options."

    t "When you run this project for the first time, you should have been able to adjust the Audio and Image Caption options."

    t "I'll make some sounds now. If Audio Captions are on, you'll see a notification in the top-left corner describing the sound."
    ...
    t upset "If you had it on, did you notice how robust that Screen Shake was? That wasn't the classic {color=#32CD32}{i}hpunch{/i}{/color}."
    ...
    t happy "Now let's try NVL Mode."
