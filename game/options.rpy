...
define config.name = _("Happy 1st Anniv!")
...
define gui.about = _p("""This project was started sometime around March 2023 ---four months away from the actual anniversary. Thought I'll be needing quite some time to get this done so, \"I better get moving, a.s.a.p.\"
    
    
    Made with so much love, effort and with you (Labidabs Jessa) in mind. <3
    ...
    Credits to the compiler of the starter template: BáiYù with additional
...
define config.window_icon = "gui/s_final_heart.png"
